...
beta_cd             = 0                 *(-5) *pi/180; % [rad/m] 
beta_cv             = 0                 *(-5) *pi/180; % [rad*s/m]

CtrlPar_Side = [beta_cd  beta_cv];
...
% M11: Damped Ankle
St_VceOffM11P       = parStCtrl(31)     *1;
St_VGainSOLM11P     = parStCtrl(32)     *1;
St_VGainTAM11P      = parStCtrl(33)     *1;
St_VGainGASM11P     = parStCtrl(34)     *1;
St_VceOffM11N       = parStCtrl(35)     *1;
St_VGainSOLM11N     = parStCtrl(36)     *1;
St_VGainTAM11N      = parStCtrl(37)     *1;
St_VGainGASM11N     = parStCtrl(38)     *1;
...
St_M11      = [St_VceOffM11P St_VGainSOLM11P St_VGainTAM11P St_VGainGASM11P St_VceOffM11N St_VGainSOLM11N St_VGainTAM11N St_VGainGASM11N];

CtrlPar_St = [StPreStim St_M1 St_M2 St_M3 St_M4 St_M5 St_M11];
...
St_i = St_i + length(St_M5); 
parSt_M11_i    = St_i + 1	: St_i + length(St_M11); 
St_i = St_i + length(St_M11); % St_i is used in the Simulink file
